...
"""
    try:
        ...
        return {"sql": parsed.get("sql"), "chart_type": parsed.get("chart_type"), "error": None}
...
async def generate_response(query: str, query_results: dict = None, chart_type: str = "table") -> dict:
    """
    ...
    try:
        ...
        if query_results and isinstance(query_results, dict) and query_results.get("success"):
